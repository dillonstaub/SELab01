...
public class AESHelper {
    ...
    public static boolean macIsValid(final String providedMac, final String key, final String data1, final String data2, final String data3) {
        String decryptedMac = AESHelper.decrypt(providedMac, key);
        Log.i("mac is valid", decryptedMac);
        return decryptedMac.equals(data1 + data2 + data3 + authCode);
    }
